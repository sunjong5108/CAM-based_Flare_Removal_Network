...
save_root = '/workspace/'
model_weights_save = os.path.join(save_root, 'DB1_proposed_model_fold1_weights_with_CAM_tv')

result_test_images_save = os.path.join(save_root, 'DB1_proposed_model_fold1_test_images_with_CAM_tv')
...
checkpoint = torch.load(os.path.join('/workspace/DB1_proposed_model_fd_fold1_weights', 'model_168.pth'))
...
checkpoint = torch.load(os.path.join(model_weights_save, 'model_371.pth'))
...
#Epoch: 381      Time: 73.0678   PSNR: 28.370533 SSIM: 0.924255 previous 400 28.13


#Epoch: 376      Time: 73.4427   PSNR: 27.4351   SSIM: 0.927135  FID: 35.9182
#Epoch: 353      Time: 69.9058   PSNR: 27.3520   SSIM: 0.927322  FID: 36.9027
#Epoch: 392      Time: 69.2363   PSNR: 27.0436   SSIM: 0.926104  FID: 36.7496