...
save_root = '/workspace/'
model_weights_save = os.path.join(save_root, 'DB2_proposed_model_fold2_weights_with_CAM_tv')

result_test_images_save = os.path.join(save_root, 'DB2_proposed_model_fold2_test_images_with_CAM_tv')
...
test_datasets = get_Kitti_val_test_dataset(
    inp_dir=Kitti_flare_fold2_test_dataset_path,
    tar_dir=Kitti_flare_fold2_test_label_path,
    flare_dir=Kitti_flare_fold2_test_flare_path
)
...
checkpoint = torch.load(os.path.join('/workspace/DB2_proposed_model_fd_fold2_weights', 'model_143.pth'))
...
checkpoint = torch.load(os.path.join(model_weights_save, 'model_390.pth'))
cam_frn.load_state_dict(checkpoint['vae_state_dict'])
discriminator.load_state_dict(checkpoint['discriminator_state_dict'])
# gen_optimizer.load_state_dict(checkpoint['gen_optimizer'])z
...
#Epoch: 390      Time: 113.4320  PSNR: 25.9723   SSIM: 0.907340  FID: 38.2950