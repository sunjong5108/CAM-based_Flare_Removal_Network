...
class Trainier(nn.Module):
    ...
    def _train_epoch(self, epoch, train_loader):
        ...
        for i, data in enumerate(tqdm(train_loader), 0):
            ...
            highres_cam = torch.sum(torch.stack([F.interpolate(o, self.strided_up_size, mode='bilinear', align_corners=False) for o in fmd_outputs]), 0)
