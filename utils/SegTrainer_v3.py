...
class Trainier(nn.Module):
    def __init__(self, train_loader, label_color_map, save_root, save_model_weights_path, device, lr, num_epochs): 
    ...
    def train(self, train_loader, val_loader, test_loader, train_batch, eval_batch):
        ...
        print('Validation')
        print('Best MIOU score index:', self.Validation_history.loc['miou'].idxmax() + 1, 'Best MIOU score:', self.Validation_history.loc['miou'].max())
        print('Test')
        print('Best MIOU score index:', self.Test_history.loc['miou'].idxmax() + 1, 'Best MIOU score:', self.Test_history.loc['miou'].max())
